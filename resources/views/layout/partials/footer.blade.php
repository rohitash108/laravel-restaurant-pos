    ...
    <div class="container-fluid px-3">
        <div class="d-flex flex-wrap align-items-center justify-content-center gap-2 gap-md-3 py-1">
            <p class="mb-0 small text-center app-site-footer__text">
                © {{ date('Y') }} Global Tea Cafe. All Rights Reserved. <span class="app-site-footer__sep mx-1">|</span> Designed by IT Software
            </p>
            <span class="app-brand-logo app-brand-logo--footer app-site-footer__logo-light" aria-hidden="true">
                <img src="{{ asset('build/img/global-tea-cafe-logo.png') }}" alt="Global Tea Cafe" width="32" height="29" decoding="async" style="object-fit:contain;">
            </span>
