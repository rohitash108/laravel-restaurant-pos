    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a href="{{url('order-report')}}" class="nav-link d-flex align-items-center active"><i class="icon-list-todo me-2"></i>Order Report</a>
                </li>
                <li class="nav-item">
                        ...
                        <table class="table mb-0 border datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-soft-{{ $order->status === 'completed' ? 'success' : 'warning' }}">{{ $order->status === 'completed' ? 'Paid' : ucfirst($order->status ?? '') }}</span></td>
                                </tr>
                                @empty
