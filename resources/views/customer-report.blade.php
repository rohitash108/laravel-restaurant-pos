    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a href="{{url('customer-report')}}" class="nav-link d-flex align-items-center active"><i class="icon-users me-2"></i>Customer Report</a>
                </li>
                    ...
                    <div class="table-responsive table-nowrap">
                        <table class="table mb-0 border datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="avatar avatar-sm avatar-rounded flex-shrink-0 me-2 bg-light border">
                                                <i class="icon-user fs-16 text-dark"></i>
                                            </span>
                                            <h6 class="fs-14 fw-normal mb-0">{{ $c->customer_name ?: 'Walk-in' }}</h6>
                                        </div>
                                    </td>
                                ...
                                @empty
                                <tr><td colspan="4" class="text-center py-4 text-muted">No customer data yet.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
