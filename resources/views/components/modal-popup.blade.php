                ...
                try {
                    ...
                    if (variations.length) {
                        ...
                        variations.forEach(function(v) {
                            ...
                            span.textContent = (v.name || "") + (isNaN(p) ? "" : " " + (window.currencySymbol || "₹") + p.toFixed(2));
                ...
                try {
                    ...
                    if (addons.length) {
                        addons.forEach(function(a) {
                            ...
                            col.innerHTML = '<div class="border p-2 rounded"><div class="d-flex align-items-center gap-2"><span class="avatar rounded-circle border bg-light flex-shrink-0" style="width:40px;height:40px;"></span><h6 class="fs-12 fw-medium mb-0">' + (a.addon_name || a.name || "").replace(/</g, "&lt;") + '</h6><span class="ms-auto small">' + (window.currencySymbol || "₹") + (isNaN(p) ? "0.00" : p.toFixed(2)) + '</span></div></div>';
