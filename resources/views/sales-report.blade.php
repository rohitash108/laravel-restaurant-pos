    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs nav-bordered nav-bordered-primary mb-4" role="tablist">
                ...
                <li class="nav-item">
                    <a href="{{url('sales-report')}}" class="nav-link d-flex align-items-center active"><i class="icon-shopping-bag me-2"></i>Sales Report</a>
                </li>
                <li class="nav-item">
                        ...
                        <table class="table mb-0 border datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-soft-{{ $order->status === 'completed' ? 'success' : 'warning' }}">{{ ucfirst($order->status ?? '') }}</span></td>
                                </tr>
                                @empty
                                <tr><td colspan="8" class="text-center py-4 text-muted">No sales in this period.</td></tr>
                                @endforelse
                            </tbody>
                        </table>
                    </div>
